...
export class ImpuestoComponent {
  ...
  calcularImpuesto() {
    if (this.salud <= 15238.60 && this.vivienda <= 3809.65 && this.educacion <= 3809.65 && this.vestimenta <= 3809.65 && this.alimentacion <= 3809.65) {
      ...
      if (this.gastosestado(this.totl)) {
        ...
        this.mensaje = "Gastos excedidos, imposible calcular";
      }
    } else {
      this.mensaje = "Uno de los campos está excedido";
    }
  }
